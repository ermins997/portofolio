        ...
        <div className="w-full h-[300px] overflow-hidden flex items-center sticky top-12">
            <div className="w-full h-[270px] border border-accent/80 bg-[#f4ffff] rounded-[8px]">
                <div className="flex flex-col h-full">
                    <div className="h-[80px] xl:h-[68px] bg-white flex flex-col xl:flex-row 
                        justify-center xl:justify-between items-center px-6 md:px-[84px] rounded-tl-[8px] rounded-tr-[8px]">
                        <div className="flex gap-2">
                            <Image
                                src="/assets/assets/journey/shape.svg"
                                width={16}
                                height={16}
                                alt=""
                            />
                    ...
                    <div className="flex-1 flex items-center justify-center xl:justify-start md:py-8 md:px-16">
                            ...
                            text-center xl:text-left xl:gap-10 px-4 xl:px-0">
                                {type === "skill" ? (
                                    <div className="w-max xl:w-[300px] h-full relative flex items-center
                                    justify-center">
                                ...
                                <div className="xl:border-1 xl:border-secondary/10 xl:pl-12 w-full"> 
