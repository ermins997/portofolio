...
const Hero = () => {
  return <section className="h-[800px] relative bg-accent/10 xl:bg-white" id="home">
    {/* header */}
    <Header
    />
    <div className="container mx-auto h-full">
        ...
        <div className="hidden xl:flex w-[55vw] h-[800px] absolute top-0 right-0 bg-accent">
            <div className="absolute w-[558px] h-[700px] bottom-0 z-40">
                <Image 
                src="/assets/assets/hero/dev.png"
                alt=""
                fill
                quality="100"
                priority
            ...
            <Image
            src="/assets/assets/hero/arrow.svg"
            width={160}
            height={160}
            alt=""
            />
            ...
            {/*shape 1 */}
            <div className="absolute top-[470px] xl:left-[3vw]" 
            data-scroll
            data-scroll-speed="0.2">
                <RotatingShape content={<Image 
                src="/assets/assets/hero/shape-1.svg"
                width={38}
                height={38}
                alt=""
                />
            ...
            {/*shape 2 */}
            <div className="absolute top-[160px] xl:left-[25vw]"
            data-scroll
            data-scroll-speed="0.1">
                <RotatingShape content={<Image 
                src="/assets/assets/hero/shape-2.svg"
                width={34}
                height={34}
                alt=""
                />
            ...
            {/*shape 3 */}
            <div className="absolute top-[480px] xl:left-[35vw]"
            data-scroll
            data-scroll-speed="0.08">
                <RotatingShape content={<Image 
                src="/assets/assets/hero/shape-3.svg"
                width={34}
                height={34}
                alt=""
                />
